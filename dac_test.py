...
right_ui = dac.NavbarDropdown(
    ...
    header_text="2 Items",
    children=[
        dac.NavbarDropdownItem(children="message 1", date="today"),
        dac.NavbarDropdownItem(children="message 2", date="yesterday"),
    ],
)

navbar = dac.Navbar(
    color="white", text="I can write text in the navbar!", children=right_ui
)
...
sidebar = dac.Sidebar(
    dac.SidebarMenu(
        [
            ...
            dac.SidebarMenuItem(
                id="tab_social_cards", label="Social cards", icon="id-card"
            ),
            dac.SidebarMenuItem(id="tab_tab_cards", label="Tab cards", icon="image"),
            dac.SidebarHeader(children="Boxes"),
            dac.SidebarMenuItem(
                id="tab_basic_boxes", label="Basic boxes", icon="desktop"
            ),
            dac.SidebarMenuItem(
                id="tab_value_boxes", label="Value/Info boxes", icon="suitcase"
            ),
        ]
    ),
    title="Dash Admin",
