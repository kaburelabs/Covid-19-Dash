...
# print(df_confirmed_t.columns.str.split("|"))
...
map_data.loc[
    map_data[map_data["Country/Region"] == "Singapore"].index.values, "new"
] = 0
...
#############################################################################
mapbox_access_token = "pk.eyJ1Ijoia2FidXJlbGFicyIsImEiOiJjazd0Nmx5Zmwwd3hzM29xbHhnMnZzemgzIn0.zXbQNivhhw9NjEmSyiC0zw"
                ...
                [
                    ...
                    html.Div(
                        [
                            html.Hr(),
                            html.P(
                                "Source Code Hosted on  ", style={"display": "inline"}
                            ),
                            html.A(
                                "Github",
                            ...
                            html.P(
                                " Click here to access ", style={"display": "inline"}
                            ),
                            html.A(
                                "Covid 19 Version 2.0 Web App",
...
def map_selection(data, selected_rows, graph_line):
    ...
    if len(selected_rows) == 0:
        fig1 = draw_singleCountry_Scatter(
            df_confirmed_t, df_deaths_t, df_recovered_t, 0
        )
        ...
        zoom = 4
        return (
            gen_map(aux, zoom, temp_df["Lat"].iloc[0], temp_df["Long"].iloc[0]),
            fig1,
            fig2,
        )
...
@app.callback(
    Output("info-button", "n_clicks"), [Input("modal-close-button", "n_clicks")]
)
def close_modal(n):
    return 0
